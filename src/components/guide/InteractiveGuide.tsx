  ...
  return <main className="guide-page">
    ...
    <section className="guide-step guide-step-tips" id="guide-tips" aria-labelledby="gesture-title">
      <div className="guide-gesture">
        <div className="guide-gesture-copy"><span className="guide-kicker">간단한 조작 팁</span><h2 id="gesture-title">카드를 가로로 밀어보세요.</h2><p>모바일에서는 카드의 빠른 기능으로 머무는 시간을 조절할 수 있어요.</p><button type="button" onClick={() => guideSwipe.setOffset((current) => current === 0 ? -getGestureRevealWidth() : 0)}>{guideSwipe.offset === 0 ? "동작 보기" : "카드 닫기"}<ChevronRight /></button></div>
      ...
      <div className="guide-use-cases"><div><span className="guide-kicker">여러 장소를 방문하는 모든 날</span><h2>외근과 약속 사이, 이동 순서를<br />더 가볍게 정해 보세요.</h2><p>RouteFit은 여러 방문 장소를 한 번에 정리하고 이동 경로를 확인할 수 있어, 목적이 다른 하루 일정에도 유용합니다.</p></div><GuideUseCaseCarousel /></div>
    </section>
